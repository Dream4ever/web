      ...
      <div className="flex flex-col items-center -mt-[570px] mb-[80px] relative w-full" ref={refMain}>
        ...
        <div className="relative w-[340px] min-h-[870px] mt-20">
          ...
          <div
            ...
            ref={ref2}
          >
            <img src="/assets/adoption/mobile2.png" className="w-[340px]" />
          ...
          <div
            className="absolute top-[615px] left-[0px] z-10 transition-all  translate-y-[100vh]"
            ref={ref3}
          >
            <img src="/assets/adoption/mobile3.png" className="w-[166px]" />
            <div className="absolute left-6 top-20">
              <p className="text-[#FFF] text-[28px] font-semibold">
                Developer <br /> - friendly
              </p>
              <p className="text-[#FFFFFF] text-sm font-normal">
                Supporting both <br /> Rust & Move <br /> language
              </p>
            </div>
          </div>
          <div
            className="absolute top-[615px] left-[175px] z-10 transition-all  translate-y-[100vh]"
            ref={ref4}
          >
            <img src="/assets/adoption/mobile4.png" className="w-[166px]" />
            <div className="absolute left-6 top-[102px]">
              <p className="text-[#FFF] text-[28px] font-semibold">Low fees</p>
              <p className="text-[#FFFFFF] text-sm font-normal">
                Interact directly <br /> with your audience <br /> and no
                middleman <br /> with low fees
              </p>
            </div>
          </div>
        </div>
