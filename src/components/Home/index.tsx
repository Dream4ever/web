    ...
    <>
      ...
      >
        <div className="absolute z-0 hidden w-full h-screen lg:block">
          ...
          />
          <img src="/images/home/mobile.svg"
            className="absolute bottom-0 left-[36.5%]"
            alt="" />
          <img
        ...
        <div className="absolute z-[9999] hidden w-full lg:block">
          <CustomLabel className="top-80 left-80" label="1.325" imgUrl="/images/home/icons/comment.svg" dotSName="-top-24 left-16" dotCName="-top-16 left-20" />
          <CustomLabel className="top-8 left-[530px]" label="#HODL" dotSName="-top-10 left-20" dotCName="-top-24 left-14" />
          <CustomLabel className="top-12 right-[544px]" label="$1,185" imgUrl="/images/home/icons/budget.svg" dotSName="-top-36 right-14" dotCName="-top-28 right-20" />
          <CustomLabel className="top-[350px] right-[324px]" imgUrl="/images/home/icons/aptos.svg" dotSName="hidden" dotCName="top-4 right-20" />
        </div>
        ...
        <div className="relative z-10 flex items-center justify-center h-full pt-24 pb-8 lg:pt-40 lg:pb-40">
          <div className="flex flex-col-reverse items-center justify-center gap-8 px-4 md:flex-row-reverse lg:flex-row lg:gap-32">
            <div className="flex flex-col gap-6 max-w-[800px] md:pr-10 lg:pr-0 items-center text-center">
              <div></div>
              <span className="text-[40px] md:text-[48px] lg:text-[56px] font-bold">
                The Web 3 social network on
              </span>
              <ActionFade imgUrl="/images/home/btn_aptos.svg" replaceImgUrl="/images/home/btn_solana.svg" />
              <span className="text-[24px] lg:text-[32px] font-medium ">
                The Non-EVM Social Layer
                <br></br>
                for Mass Adoption
              </span>
              <div className="flex justify-center w-full gap-6 md:item-center lg:justify-center">
                <button>
